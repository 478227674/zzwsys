    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <span v-if="scope.row.financeExamine==2">未通过</span>
          <span v-if="scope.row.financeExamine==1">已通过</span>
        </template>
      </el-table-column>
      <el-table-column
        label="详情"
      ...
      >
        <template slot-scope="scope">
          <el-button v-if="scope.row.financeExamine == 0" @click="checkRefund(scope.row,1)" type="text">通过</el-button>
          <el-button v-if="scope.row.financeExamine == 0" @click="checkRefund(scope.row,2)" type="text">拒绝</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
  ...
  export default {
    ...
    methods: {
      ...
      checkRefundFn(id,type,value){
        this.http.post('/schoolRefund/updateSchoolRefundByFinance', {id:id,financeExamine:type,financeDetail:value}).then(res => {
          if (res.code == 0) {
